...
//
// Hosts five child panels (text editor, image upload, video upload,
// stream, web) under one sidebar nav entry. Renders the page head + a
// 5-tab subnav strip; tab clicks (and deep-link URLs `#/slides/text`,
// `#/slides/image`, `#/slides/video`, `#/slides/stream`, `#/slides/web`)
// toggle which child pane is visible.
//
...
const TABS = [
    ...
    { key: "web",   label: "Web",   type: "web",        noun: "Web"   },
];
...
const TEMPLATE = `
    <section class="slides-shell">
        <div class="om-page-head">
            <div>
                <span class="om-eyebrow">Library · 5 sources</span>
                <h1>Slides</h1>
                <p>Build text, drop in images, loop a video, pull a live stream, or show a web page. Each slide previews at your sign's resolution.</p>
            </div>
 ...
 * mounting the child panels (one per SLIDE_SOURCES entry) separately
 * into the .tab-pane[data-tab=X] slots this shell expects as siblings.
 *
